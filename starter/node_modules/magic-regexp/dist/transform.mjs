    ...
    transform(code, id) {
      ...
      walk(this.parse(code), {
        enter(_node) {
          ...
          if (
            // Normal call
            !wrapperNames.includes(node.callee.name) && // Namespaced call
            (node.callee.type !== "MemberExpression" || node.callee.object.type !== "Identifier" || node.callee.object.name !== namespace || node.callee.property.type !== "Identifier" || node.callee.property.name !== "createRegExp")
          ) {
            return;
          }
