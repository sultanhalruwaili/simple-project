...
declare const charIn: <T extends string>(chars: T) => Input<`[${EscapeChar<T>}]`, never, []>;
/** This matches any character that is not in the string provided */
declare const charNotIn: <T extends string>(chars: T) => Input<`[^${EscapeChar<T>}]`, never, []>;
 ...
 */
declare const anyOf: <Inputs extends InputSource[]>(...inputs: Inputs) => Input<`(?:${Join<MapToValues<Inputs>>})`, MapToGroups<Inputs>, MapToCapturedGroupsArr<Inputs>>;
 ...
 * @argument inputs - arbitrary number of `string` or `Input`, where `string` will be escaped
 */
declare const maybe: <Inputs extends InputSource[], Value extends string = Join<MapToValues<Inputs>, "", "">>(...inputs: Inputs) => Input<IfUnwrapped<Value, `(?:${Value})?`, `${Value}?`>, MapToGroups<Inputs>, MapToCapturedGroupsArr<Inputs>>;
 ...
 * @argument inputs - arbitrary number of `string` or `Input`, where `string` will be escaped
 */
declare const exactly: <Inputs extends InputSource[]>(...inputs: Inputs) => Input<Join<MapToValues<Inputs>, "", "">, MapToGroups<Inputs>, MapToCapturedGroupsArr<Inputs>>;
 ...
 * @argument inputs - arbitrary number of `string` or `Input`, where `string` will be escaped
 */
declare const oneOrMore: <Inputs extends InputSource[], Value extends string = Join<MapToValues<Inputs>, "", "">>(...inputs: Inputs) => Input<IfUnwrapped<Value, `(?:${Value})+`, `${Value}+`>, MapToGroups<Inputs>, MapToCapturedGroupsArr<Inputs>>;
...
interface Input<V extends string, G extends string = never, C extends (string | undefined)[] = []> {
     ...
     */
    and: {
        <I extends InputSource[], CG extends any[] = MapToCapturedGroupsArr<I>>(...inputs: I): Input<`${V}${Join<MapToValues<I>, '', ''>}`, G | MapToGroups<I>, [
            ...C,
            ...CG
        ]>;
...
export { maybe as A, exactly as B, oneOrMore as C, MapToStringCapturedBy as D, Flag as F, InputSource as I, Join as J, MagicRegExp as M, StringCapturedBy as S, UnionToTuple as U, MagicRegExpMatchArray as a, MapToValues as b, MapToGroups as c, MapToCapturedGroupsArr as d, caseInsensitive as e, dotAll as f, global as g, Input as h, charIn as i, charNotIn as j, anyOf as k, char as l, multiline as m, word as n, wordChar as o, wordBoundary as p, digit as q, whitespace as r, sticky as s, letter as t, unicode as u, tab as v, withIndices as w, linefeed as x, carriageReturn as y, not as z };
